...
Python Разработчик. hhttps://stepik.org/course/122813/syllabus ссылка на курса
## В данном репозитории находятся мои варианты решений с данного курса. В данном файле условия к задачам и ссылки на их
решение ##
